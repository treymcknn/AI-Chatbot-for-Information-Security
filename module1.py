...
records = [{ "_id": "rec1", "chunk_text": "The Eiffel Tower was completed in 1889 and stands in Paris, France.", "category": "history" },
           { "_id": "rec2", "chunk_text": "Photosynthesis allows plants to convert sunlight into energy.", "category": "science" },
            ...
            { "_id": "rec55", "chunk_text": "A type of attack where malicious SQL statements are inserted into an entry field for execution.", "category": "sql_injection" },
            { "_id": "rec56", "chunk_text": "A system that detects and alerts on potential security breaches or malicious activities within a network.", "category": "intrusion_detection_system" },
            { "_id": "rec57", "chunk_text": "A system designed to automatically block or prevent detected intrusions from succeeding.", "category": "intrusion_prevention_system" },
            { "_id": "rec58", "chunk_text": "A framework that outlines how an organization manages and governs cybersecurity risk.", "category": "security_governance" },
            { "_id": "rec59", "chunk_text": "The unauthorized copying, transfer, or use of sensitive data outside an organization's boundaries.", "category": "data_exfiltration" },
            { "_id": "rec60", "chunk_text": "A fake website or service designed to trick users into revealing sensitive information.", "category": "spoofing" },
            { "_id": "rec61", "chunk_text": "An attack that targets software vulnerabilities before developers have released a patch or fix.", "category": "zero_day_attack" },
            { "_id": "rec62", "chunk_text": "The process of ensuring that data is accessible only to those authorized to view it.", "category": "confidentiality" },
            { "_id": "rec63", "chunk_text": "The discipline focused on protecting cloud-based data, applications, and infrastructure.", "category": "cloud_security" },
            { "_id": "rec64", "chunk_text": "A document that defines an organization's security practices, roles, and responsibilities.", "category": "information_security_policy" },
            { "_id": "rec65", "chunk_text": "Software updates designed to fix vulnerabilities or bugs in applications and systems.", "category": "security_patch" },
            { "_id": "rec66", "chunk_text": "An attack where cybercriminals intercept and alter communications between two parties without their knowledge.", "category": "session_hijacking" },
            { "_id": "rec67", "chunk_text": "A measure used to restore operations and data access following a cybersecurity incident or disaster.", "category": "business_continuity" },
            { "_id": "rec68", "chunk_text": "An email scam targeting specific individuals or organizations using personalized messages.", "category": "spear_phishing" },
            { "_id": "rec69", "chunk_text": "A testing method that examines a system's internal structure or workings to find vulnerabilities.", "category": "white_box_testing" },
            { "_id": "rec70", "chunk_text": "Malicious code or scripts inserted into trusted software updates to compromise systems.", "category": "supply_chain_attack" },
            { "_id": "rec71", "chunk_text": "A cybersecurity model that assumes no user or device should be trusted by default, even inside the network.", "category": "zero_trust_architecture" },
            { "_id": "rec72", "chunk_text": "A system that continuously monitors network traffic to detect and respond to potential security threats.", "category": "security_information_and_event_management" },
            { "_id": "rec73", "chunk_text": "A backup process that stores encrypted data copies to ensure recoverability in case of a cyberattack.", "category": "data_backup_and_recovery" },
            { "_id": "rec74", "chunk_text": "A practice of evaluating a vendor or partner's security controls before granting them access to systems or data.", "category": "third_party_risk_management" },
            { "_id": "rec75", "chunk_text": "An attack that uses fraudulent text messages to trick individuals into revealing personal information.", "category": "smishing" },
            { "_id": "rec76", "chunk_text": "A security testing technique where ethical hackers simulate real-world attacks to identify weaknesses.", "category": "red_team_exercise" },
            { "_id": "rec77", "chunk_text": "The process of verifying that a system or application meets security requirements before deployment.", "category": "security_validation" },
            { "_id": "rec78", "chunk_text": "An individual within an organization who poses a security threat, intentionally or unintentionally.", "category": "insider_threat" },
            { "_id": "rec79", "chunk_text": "A malicious attachment or link delivered through email that installs malware on a victim's device.", "category": "email_attachment_attack" },
            { "_id": "rec80", "chunk_text": "A process of converting data into an unreadable format to protect it during transmission or storage.", "category": "data_encryption" },
            { "_id": "rec81", "chunk_text": "The use of digital certificates to verify the authenticity and integrity of a message or software.", "category": "digital_signature" },
            { "_id": "rec82", "chunk_text": "A software vulnerability that allows attackers to execute arbitrary commands on a host operating system.", "category": "command_injection" },
            { "_id": "rec83", "chunk_text": "A security practice that involves continuously testing systems to find new vulnerabilities and threats.", "category": "continuous_security_testing" },
            { "_id": "rec84", "chunk_text": "A network security measure that separates systems based on trust levels to prevent unauthorized access.", "category": "network_segmentation" },
            { "_id": "rec85", "chunk_text": "A tool or platform that automatically scans software for known vulnerabilities and misconfigurations.", "category": "vulnerability_scanner" },
            { "_id": "rec86", "chunk_text": "A type of malware that spreads itself across systems without user intervention.", "category": "worm" },
            { "_id": "rec87", "chunk_text": "A file or program that appears legitimate but hides malicious code.", "category": "trojan_horse" },
            { "_id": "rec88", "chunk_text": "A process that ensures systems are configured securely and remain compliant with security policies.", "category": "configuration_management" },
            { "_id": "rec89", "chunk_text": "A method of limiting network access to authorized users and devices only.", "category": "network_access_control" },
            { "_id": "rec90", "chunk_text": "A strategy that combines multiple layers of security controls throughout an IT system.", "category": "defense_in_depth" },
            { "_id": "rec91", "chunk_text": "Software that records user actions, often used maliciously to steal credentials or personal data.", "category": "keylogger" },
            { "_id": "rec92", "chunk_text": "A program that covertly gathers user data without consent and transmits it to a third party.", "category": "spyware" },
            { "_id": "rec93", "chunk_text": "The process of confirming that users are who they claim to be using credentials like passwords or biometrics.", "category": "identity_verification" },
            { "_id": "rec94", "chunk_text": "A proactive cybersecurity approach that focuses on identifying and mitigating threats before they cause harm.", "category": "threat_hunting" },
            { "_id": "rec95", "chunk_text": "Airplanes fly due to the principles of lift and aerodynamics.", "category": "physics" },
